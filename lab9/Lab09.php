...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              foreach ($countries as $name){
                  echo '<a role ="button" class="btn btn-default" href="list.php?country='.$name.'">'.$name.'</a>';
              }
              ?>
   ...
   //              </a>
          ...
          foreach ($images as $key => $image){
              echo "<li>";
              echo '<a href="detail.php?id='.$key.'" class="img-responsive">';
              echo '<img src="images/square/'.$image["path"].'" alt="'.$image["description"].'">';
              echo '<div class="caption">';
              echo '<div class="blur"></div>';
              echo '<div class="caption-text">';
              echo '<h1>'.$image["description"].'</h1>';
              echo '</div>';
              echo '</div>';
              echo "</a>";
              echo "</li>";
